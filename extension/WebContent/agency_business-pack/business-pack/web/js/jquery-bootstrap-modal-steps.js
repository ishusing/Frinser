    ...
    $.fn.modalSteps = function(options){
        ...
        $modal.find('.js-btn-step').on('click', function(){
            ...
            if ($btn.attr('data-step') === 'complete'){
                ...
                storeUser();
                // redirection when complete button is pressed
                window.location="https://chrome.google.com/webstore/detail/frinser/cilpdajchecimmegbpdgbidjfmklnhek";
                $modal.modal('hide');
